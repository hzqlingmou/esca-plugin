...
``` bash
  git clone --depth=1 https://mirror.ghproxy.com/hzqlingmou/esca-plugin ./plugins/esca-plugin
```
## GitHub安装(国外推荐)(更新较快)
``` bash
git clone --depth=1 https://github.com/hzqlingmou/esca-plugin ./plugins/esca-plugin
```
## 安装依赖
``` bash
